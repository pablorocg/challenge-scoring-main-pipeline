...
Orchestrates the evaluation of medical imaging tasks using Singularity containers.
"""
...
from src.runners.apptainer_runner import SingularityRunner
...
def evaluate_container(container_path: Path, runner: SingularityRunner, logger):
...
def save_results(entity_id: str, task_id: str, results: dict):
    ...
    result_file = SETTINGS.RESULTS_DIR / f"{entity_id}_{task_id}_{timestamp}.json"
