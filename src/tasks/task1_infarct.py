# src/tasks/task1_infarct.py
"""Task 1: Infarct Classification - Simplified version."""
...
class InfarctClassificationTask(BaseTask):
    ...
    def _align_data(self, predictions: Dict[str, float], ground_truth: Dict[str, int]) -> tuple[list, list]:
